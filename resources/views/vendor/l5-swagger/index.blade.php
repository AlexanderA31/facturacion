    ...
    <script>
        window.onload = function () {
            ...
            const ui = SwaggerUIBundle({
                ...
                deepLinking: true,
                displayOperationId: {!! config('l5-swagger.defaults.ui.display.operation_id') ? 'true' : 'false' !!},
                displayRequestDuration: {!! config('l5-swagger.defaults.ui.display.request_duration') ? 'true' : 'false' !!},
                filter: {!! config('l5-swagger.defaults.ui.display.filter') ? 'true' : 'false' !!},
                persistAuthorization: "{!! config('l5-swagger.defaults.ui.authorization.persist_authorization') ? 'true' : 'false' !!}",
                syntaxHighlight: true,
                syntaxHighlight: {
                    activated: {{ config('l5-swagger.defaults.ui.display.syntax_highlight.activated') ? 'true' : 'false' }},
                    theme: "{{ config('l5-swagger.defaults.ui.display.syntax_highlight.theme') }}",
                }
            })
            ...
            // Espera a que Swagger UI termine de renderizar
            setTimeout(() => {
                ...
                if (auth_wrapper) {
                    ...
                    logoutButton.style.background = '#c53030';
                    ...
                    logoutButton.onclick = function () {
                        // Puedes hacer fetch a tu endpoint /logout
                        fetch('/logout', {
                            method: 'POST',
                            headers: {
                            ...
                            .then(res => {
                                if (res.ok) {
                                    ...
                                    window.location.href = '/login'; // Cambia si tu ruta es distinta
                                } else {
                    ...
                    auth_wrapper.appendChild(logoutButton);
                }
            }, 1000); // espera 1 segundo para asegurar que `.topbar` ya existe
        }
    </script>
</body>
