<template>
  <div class="relative min-h-screen md:flex">
    ...
    <!-- Sidebar -->
    <div :class="['bg-gray-800 text-white w-64 flex flex-col justify-between absolute inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out', isSidebarOpen ? 'translate-x-0' : '-translate-x-full']">
      <div>
