<template>
  ...
  >
    ...
    <div v-if="currentDashboardView === 'individual-billing'">
      <IndividualBilling :token="token" :establecimientos="establecimientos" :puntos-emision="puntosEmision" />
    </div>
  </AppLayout>
</template>
...
const IconIndividualBilling = {
  render() { return h('svg', { fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' }, [ h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L15.232 5.232z' }) ]); }
};
const IconStatus = {
