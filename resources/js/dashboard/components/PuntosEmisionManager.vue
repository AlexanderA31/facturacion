    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        ...
        <DataTable :data="puntosEmision" :headers="headers" :is-loading="isLoading">
            <template #cell(actions)="{ row }">
                <div class="space-x-2">
                    <button @click="openEditModal(row)" title="Editar" class="p-1 text-yellow-600 hover:text-yellow-800">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                    </button>
                    <button @click="confirmReset(row)" title="Reiniciar Secuencial" class="p-1 text-blue-600 hover:text-blue-800">
                    ...
                    <button @click="confirmDelete(row)" title="Eliminar" class="p-1 text-red-600 hover:text-red-800">
