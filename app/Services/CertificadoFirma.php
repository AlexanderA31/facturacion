...
class CertificadoFirma
{
    public function handleCertificate($certificateFile, $certificateKey, $expectedRuc, $existingCertificatePath = null)
    {
        ...
        try {
            ...
            // 3. Validación de RUC deshabilitada por solicitud del usuario.
            // WARNING: Saltarse esta validación es inseguro.
            Log::info("Paso 3: Saltando validación de RUC por solicitud del usuario.");
